...
public class Sensei extends Usuario{
	public Sensei(String nombreUsuario, String claveUsuario,int tiempo,int id) {
	...
	public void mostrarMenu() {
		...
		System.out.println("**  MENU SENSEI **");
		...
		for (int i = j; i < dias.length; i++) {
					...
					try {
			            ...
			            while(rst.next()) {
			            	if(rst.getString("nombre").equals("yoga") || rst.getString("nombre").equals("actuacion")|| rst.getString("nombre").equals("ensayo musical")) {
			            		if(k==0) {
