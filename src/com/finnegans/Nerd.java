...
public class Nerd extends Usuario{
	public Nerd(String nombreUsuario, String claveUsuario,int tiempo,int id) {
	...
	public void mostrarMenu() {
		...
		for (int i = j; i < dias.length; i++) {
					...
					try {
			            ...
			            while(rst.next()) {
			            	if(rst.getString("nombre").equals("yoga") || rst.getString("nombre").equals("metegol")|| rst.getString("nombre").equals("cyberjuegos-fifa")|| rst.getString("nombre").equals("cyberjuegos-mathemats")) {
			            		if(k==0){
